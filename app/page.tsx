        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              <li>
                <strong>Audit —</strong> We analyze your past bills, usage, and supplier contracts to uncover hidden
                overcharges.
              </li>
              <li>
                <strong>Strategy —</strong> We structure your procurement around data-driven block-index models that
                protect against volatility.
              </li>
              <li>
                <strong>Execution —</strong> We negotiate directly with suppliers to secure pricing that aligns with your
          ...
          <div className="bg-white shadow-lg rounded-2xl p-8">
            ...
            <a href="/contact" className="btn btn-primary inline-block mt-6">
